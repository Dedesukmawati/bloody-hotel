...
//untuk membuat routens untuk  user sukses login
...
########### ROUTES UNTUK menampilkan DATA RESERVASI ############################
$routes->get('/tampil-Reservasi','Reservasi::index',['filter'=>'otentifikasi']);

############ ROUTES UNTUK MENGOLAH RESERVASI ############
