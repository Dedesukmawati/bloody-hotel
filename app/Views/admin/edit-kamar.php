...
<div class="form-group">
	...
	<input class="form-control" type="text" name="txtJumlahKamar" value="<?=$Kamar['jumlah_kamar'];?>" autocomplete="off"/>
</div>
	...
	if(isset($listFasilitasKamar)){
    	...
    	foreach($listFasilitasKamar as $row) {
        	...
        	<div class="custom-control custom-checkbox">
            	...
            	<label class="custom-control-label" for="customCheck-'.$a.'">'.$row['nama_kamar'].'</label>       	 
        	</div>
        	';
