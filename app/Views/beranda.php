...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-success border-bottom shadow-lg">
  <h5 class="my-0 mr-md-auto font-weight-normal">BLOODY HOTEL</h5>
  ...
  <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
	<h1 class="display-4"><?=isset($JudulHalaman) ? $JudulHalaman : 'Selamat Datang Di Bloody Hotel';?></h1>
    ...
    <div class="card mb-4 shadow-sm">
  	...
  	<div class="card-body">
    	...
    	<ul class="list-unstyled mt-3 mb-4">
      	<li><?=$row['jumlah_kamar'];?> Kamar Tersedia</li>
   			 ...
   			 <?php
                	...
                	if(isset($fasiltias)){
                    	foreach($fasiltias as $rowFasilitas){
                        	...
                        	'.$rowFasilitas['nama_kamar'].'</div>';
                    	}
                	}
   			 ?>
   			 <li>
    	</ul>
    	<a href="<?=site_url('/order/'.$row['id_kamar']);?>" class="btn btn-sm btn-block btn-outline-danger<?=$row['jumlah_kamar'] == 0 ? 'disabled' : null;?>">Pesan Sekarang</a>
  	</div>
	</div>
