...
class Reservasi extends BaseController
{
   ...
   public function setStatusOut($id_reservasi){
	...
	public function invoice($idReservasi){
    	...
    	$html .= '<th width="25px"><br/>No<br/></th>
              	<th width="250px">Item</th>
              	<th width="55px"><br/>Qty<br/></th>
              	<th width="85px"><br/>Price<br/></th>
              	<th width="115px"><br/>Amount<br/></th>';
    	$html .= '</tr>';
    	$html .= '</thead>';

    	$html .='<tr style="background-color:"" min-height:400px">
    	<td width="25px">1</td>
